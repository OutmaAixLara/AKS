...
param aksClusterSshPublicKey string = 'test'
...
var applicationGatewaySubnetId = resourceId(
...
var blobPrivateDnsZoneGroupId = resourceId(
  'Microsoft.Network/privateEndpoints/privateDnsZoneGroups',
  blobStorageAccountPrivateEndpointName,
  '${blobStorageAccountPrivateEndpointGroupName}PrivateDnsZoneGroup'
)
...
var acrPrivateDnsZoneGroupId = resourceId(
  'Microsoft.Network/privateEndpoints/privateDnsZoneGroups',
  acrPrivateEndpointName,
  '${acrPrivateEndpointGroupName}PrivateDnsZoneGroup'
)
...
var keyVaultPrivateDnsZoneGroupId = resourceId(
  'Microsoft.Network/privateEndpoints/privateDnsZoneGroups',
  keyVaultPrivateEndpointName,
  '${keyVaultPrivateEndpointGroupName}PrivateDnsZoneGroup'
)
...
resource publicIPPrefix 'Microsoft.Network/publicIPPrefixes@2021-03-01' = {
...
resource bastionHostName_Microsoft_Insights_default 'Microsoft.Network/bastionHosts/providers/diagnosticSettings@2021-05-01-preview' = {
...
/*resource vmSubnetNsgName_Microsoft_Insights_default 'Microsoft.Network/networkSecurityGroups/providers/diagnosticSettings@2021-05-01-preview' = {
...
resource keyVaultName_Microsoft_Insights_default 'Microsoft.KeyVault/vaults/providers/diagnosticSettings@2021-05-01-preview' = {
...
resource acrName_Microsoft_Insights_default 'Microsoft.ContainerRegistry/registries/providers/diagnosticSettings@2021-05-01-preview' = {
